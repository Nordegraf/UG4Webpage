...
--
--  \title Loading a Domain
--
--  \brief This tutorial will give you a first idea on how to use a lua script 
--  to steer ug. We will examine how to use command line arguments to specify 
--  filename and a dimension and on how to load and save a domain. Furthermore 
--  we will distribute the domain to all involved processes.
--
