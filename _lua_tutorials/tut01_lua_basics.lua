--------------------------------------------------------------------------------
--	\file tut01_lua_basics.lua
--
--  \title lua Basics
--
--  \brief This tutorial introduces the basic concepts of the Lua scripting
--  language. It is intended for users who are new to Lua and want to learn the
--  basics. In contrary to the following scripting tutorials, it will not yet
--  use any command specific to ug4.
--
